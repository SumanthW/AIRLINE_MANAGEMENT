...
create table AIRCRAFT(id number GENERATED BY DEFAULT AS IDENTITY, PRIMARY KEY(id), NAME varchar2(20), COMPANY varchar2(10), AC_TYPE number,PAX_CAP NUMBER, CARGO_CAP NUMBER, AC_COST NUMBER, RUNWAY_LEN number, FUEL_PER_KM number, SPEED number);
